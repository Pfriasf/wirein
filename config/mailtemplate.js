module.exports.generateTemplate = (token) => {
    ...
    @media only screen and (max-width:480px) {
      ...
      <img
         alt="" height="auto" src="https://i.imgur.com/BUR4om1_d.webp?maxwidth=760&fidelity=grand" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600"
      />
        ...
        <tr>
          ...
          >
            ...
            href="${process.env.HOST || `http://localhost:${process.env.PORT || 3000}`}/activate/${token}"
               style="display:inline-block;background:#9acd32;color:#ff0a4d;font-family:open Sans Helvetica, Arial, sans-serif;font-size:22px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:10px;"
            >
              Verify me!
            </a>
          </td>
